...
async function loadCategoryData(): Promise<Record<string, CategoryData>> {
  ...
  try {
    for (const category of categories) {
      try {
        // 【物理隔离智能接管】
        if (category === "opera" || category === "musical" || category === "classical" || category === "music" || category === "electronic") {
        ...
        >
          ...
          <div className="aspect-[4/3] w-full overflow-hidden bg-hmc-placeholder relative">
            <Image
              ...
              unoptimized={category === "opera" || category === "musical" || category === "classical" || category === "music" || category === "electronic"}
            />
          </div>
        </a>
