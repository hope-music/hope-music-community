...
export default function ElectronicPerformancePage() {
  const { events: allEvents, loading } = useStageProductionsEvents("electronic");
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      {/* Header */}
      <PerformancePageHeader title="Electronic &amp; Dance" totalCount={allEvents.length} />
