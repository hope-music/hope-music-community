...
export default function PerformanceArtPage() {
  const { events: allEvents, loading } = useStageProductionsEvents("performance-art");
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      {/* Header */}
      <PerformancePageHeader title="Performance Art &amp; Variety" totalCount={allEvents.length} />
