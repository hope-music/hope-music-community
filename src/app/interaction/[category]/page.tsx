        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative flex-1 max-w-md">
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-hmc-orange focus:border-transparent outline-none"
            />
          ...
          <select
            ...
            className="px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:ring-2 focus:ring-hmc-orange focus:border-transparent outline-none"
          >
          ...
          {/* New Topic Button */}
          <button className="px-4 py-2 bg-hmc-orange text-white rounded-lg text-sm font-medium hover:bg-hmc-orange transition-colors flex items-center gap-2">
              ...
              <div className="p-2">
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${
                    !currentCategory
                      ? "bg-hmc-orange/10 text-hmc-orange font-medium"
                ...
                {ALL_CATEGORIES.map((cat) => (
                  ...
                  >
                    ...
                    <span className={`text-xs ${currentCategory === cat.value ? "text-hmc-orange" : "text-gray-400"}`}>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        {/* Content */}
                        <div className="flex-1 min-w-0">
                          <h3 className="text-base font-medium text-gray-900 hover:text-hmc-orange line-clamp-2 mb-1">
                            {post.title}
                          </h3>
            ...
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden sticky top-6">
              ...
              <div className="p-4 space-y-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-hmc-orange">{currentCategoryCount}</div>
