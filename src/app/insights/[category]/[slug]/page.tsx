    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="inline-block h-12 w-12 animate-spin rounded-full border-4 border-gray-200 border-t-hmc-orange mb-4" />
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center py-20">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-6">This insight doesn&apos;t exist or has been removed.</p>
          <Link
            href="/insights"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-hmc-orange text-white rounded-lg hover:bg-orange-600 transition-all"
          >
            Back to Insights
          </Link>
        </div>
      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="bg-white border-b border-gray-100 shadow-sm">
          <div className="mx-auto max-w-4xl px-4 py-4">
            <nav className="flex items-center gap-2 text-sm">
              ...
              <Link href="/insights" className="text-gray-400 hover:text-hmc-orange transition-colors">
                Insights
              </Link>
              <span className="text-gray-300">/</span>
        ...
        <div className="bg-gradient-to-br from-hmc-orange/5 via-white to-orange-50 py-12">
          <article className="max-w-4xl mx-auto px-4">
            ...
            {/* Title */}
            <h1
              className={`text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6 transition-all duration-700 ${
            ...
            {/* Meta Info Bar */}
            <div
              className={`flex flex-wrap items-center gap-6 pb-8 border-b border-gray-200 transition-all duration-700 delay-100 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
            >
              {insight.authorName && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{insight.authorName}</p>
                  </div>
                </div>
              )}
        ...
        {insight.coverImage && (
          <div className="max-w-5xl mx-auto px-4 -mt-8 relative z-10">
            <div
              ...
              onClick={() => openLightbox(insight.coverImage)}
            >
              <img
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="relative">
            ...
            <div
              className={`prose prose-lg lg:prose-xl text-gray-700 max-w-none transition-all duration-700 delay-200 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
            >
              <style jsx>{`
          ...
          <div className="mt-16 pt-8 border-t border-gray-200">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-3 py-1 bg-gray-100 text-gray-600 text-sm rounded-full">Insight</span>
          ...
          {insight.authorName && (
            <div className="mt-12 p-6 bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl border border-orange-100">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-hmc-orange font-medium">Insight Author</p>
                  <h3 className="text-xl font-bold text-gray-900">{insight.authorName}</h3>
        ...
        <div className="bg-gray-50 border-t border-gray-200 py-12">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Enjoyed this insight?</h3>
            <p className="text-gray-500 mb-6">Check out more insights and updates from Hope Music Community</p>
            <Link
              href="/insights"
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Share your thoughts on this insight</p>
          </div>
          <CommentSection
            pageId={`insights-${insight._id}`}
            storageKey="insights_comments"
            bannedUsersKey="insights_banned_users"
            title="Insights"
          />
        </div>
      </main>
